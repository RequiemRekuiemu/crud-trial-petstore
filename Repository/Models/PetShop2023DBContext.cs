...
namespace Repository.Models
{
    public partial class PetShop2023DBContext : DbContext
    {
        ...
        private string GetConnectionString()
        {
            ...
            .Build();
            var strConn = config["ConnectionStrings:PetShop2023DB"];
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<PetShopMember>(entity =>
            {
                entity.HasKey(e => e.MemberId)
                    .HasName("PK__PetShopM__0CF04B38DE4C7899");

                entity.ToTable("PetShopMember");

                entity.HasIndex(e => e.EmailAddress, "UQ__PetShopM__49A14740D487D6E6")
                    .IsUnique();
